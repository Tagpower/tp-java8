...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson() {
    	return i -> new Person("first_"+i, "last_"+i, i, "pass_"+i);
    };
    // end::intToPerson[]
    ...
    private Function<Person, Account> personToAccount() {
    	return p -> {Account a = new Account();
    				a.setOwner(p);
    				a.setBalance(1000);
    				return a;};
    };
    ...
    private Function<Integer, Account> intToAccountWithCompose() {
		//return intToPerson().andThen(personToAccount());
    	return personToAccount().compose(intToPerson());
    };
    ...
    private Function<Integer, Account> intToAccountWithAndThen() {
    	return intToPerson().andThen(personToAccount());
    };
